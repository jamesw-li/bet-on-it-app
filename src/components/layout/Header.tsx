      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/leaderboard" className="text-slate-600 hover:text-slate-900 font-medium transition-colors">
              Leaderboard
            </Link>
            <Link to="/settlements" className="text-slate-600 hover:text-slate-900 font-medium transition-colors">
              Settlements
            </Link>
          </nav>
